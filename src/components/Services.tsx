...
const services = [
  {
    ...
    description: "Tratamiento sin dolor de problemas musculoesqueléticos, incluyendo dolor de espalda, cervicales, articulaciones y músculo. Técnicas suaves y efectivas para aliviar el malestar.",
    icon: (
    ...
    // Corregida la ruta con barra inicial
    image: "/lovable-uploads/e8d90d0d-0c36-4f16-b9a6-fa242dd1d265.png"
  },
  {
    id: 2,
    title: "Osteopatía Visceral",
    description: "Mejora de la función de órganos internos sin provocar dolor, tratamiento de problemas digestivos, respiratorios y dolores musculoesqueléticos referidos. Técnicas gentiles y respetuosas con el cuerpo.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-osteo-green" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Tratamiento suave y sin dolor de cefaleas, migrañas, problemas de ATM, vértigos y otros trastornos relacionados con el sistema nervioso. Abordaje no invasivo y muy confortable.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-osteo-green" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const Services = () => {
  ...
  // Añadimos la función de scroll suave que usamos en el resto
      ...
      <div className="container mx-auto">
        ...
        >
          <div className="inline-block p-8 rounded-2xl bg-white shadow-soft">
            ...
            {/* Convertido el enlace en un botón con scroll */}
            <button 
